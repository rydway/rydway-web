      ...
      <CardContent>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <div className="p-3 bg-muted/50 rounded-lg">
            ...
            <p className="text-sm font-semibold text-foreground">{vehicle.fuelType}</p>
          </div>
          ...
          <div className="p-3 bg-muted/50 rounded-lg">
            ...
            <p className="text-sm font-semibold text-foreground">{vehicle.seats} seats</p>
          </div>
          ...
          <div className="p-3 bg-muted/50 rounded-lg">
            ...
            <p className="text-sm font-semibold text-foreground">{vehicle.doors || 4} doors</p>
          </div>
          ...
          <div className="p-3 bg-muted/50 rounded-lg">
            ...
            <p className="text-sm font-mono font-semibold text-foreground">{vehicle.plateNumber}</p>
          </div>
