...
export default function DashboardLayout({
  ...
  const [userRole, setUserRole] = useState<'renter' | 'business'>('business');
          ...
          <div className="mb-4 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex gap-2">
                <Button
                  size="sm"
                  variant={userRole === 'renter' ? 'default' : 'outline'}
                  onClick={() => setUserRole('renter')}
                  className={cn(
                    userRole === 'renter' && "bg-blue-600 hover:bg-blue-700"
                  )}
                >
                  Renter
                </Button>
                <Button
                  ...
                  className={cn(
                    userRole === 'business' && "bg-blue-600 hover:bg-blue-700"
                  )}
                >
                  Business
                </Button>
