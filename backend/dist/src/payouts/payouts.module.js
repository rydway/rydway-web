...
const host_earnings_controller_1 = require("./host-earnings.controller");
const admin_payouts_controller_1 = require("./admin-payouts.controller");
...
exports.PayoutsModule = PayoutsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [host_earnings_controller_1.HostEarningsController, admin_payouts_controller_1.AdminPayoutsController, payouts_controller_1.PayoutsController],
