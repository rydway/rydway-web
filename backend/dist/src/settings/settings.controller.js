...
let SettingsController = class SettingsController {
    ...
    async updateSecuritySettings(user) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get profile settings' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Update profile settings' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, settings_service_1.UpdateProfileSettingsDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, settings_service_1.UpdateNotificationSettingsDto]),
    __metadata("design:returntype", Promise)
], SettingsController.prototype, "updateNotificationSettings", null);
__decorate([
    (0, common_1.Patch)('security'),
    (0, swagger_1.ApiOperation)({ summary: 'Update security settings (redirects to password change)' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
