...
export function StatCard({ 
  ...
  return (
    <Card className={cn(
      " dark:border-slate-800  hover:shadow-md transition-all duration-200 font-primary",
      className
    )}>
      <CardContent className="p-4">
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-xl font-semibold text-slate-800 dark:text-white font-primary">
              {value}
            </p>
            <p className={cn(
