...
export const PolicyGate: React.FC<PolicyGateProps> = ({
        ...
        <div className="flex flex-col md:flex-row items-start gap-6">
          ...
          <div className="flex-1 space-y-3">
            ...
            <div className="pt-4 flex flex-wrap gap-4">
              <Link 
                href="/support"
                className="px-5 py-2.5 rounded-xl text-sm font-semibold bg-red-500 text-white shadow-lg shadow-red-500/20 hover:bg-red-600 hover:shadow-red-600/30 transition-all duration-200"
              >
                Contact Support
              </Link>
              <Link 
            ...
            <div className="pt-4 flex flex-wrap gap-4">
              {!isPending ? (
                <Link 
                  ...
                  className="px-5 py-2.5 rounded-xl text-sm font-semibold bg-amber-500 text-black hover:bg-amber-600 transition-all duration-200 flex items-center gap-2 group font-bold"
                >
                  <FileText size={16} />
  ...
  return (
    <div className="w-full max-w-2xl mx-auto my-8 p-8 rounded-2xl border border-slate-800 bg-black/40 backdrop-blur-xl text-center space-y-4">
      <div className="inline-block p-4 rounded-full bg-slate-900 border border-slate-800 text-slate-400">
        <ShieldAlert size={28} />
      </div>
